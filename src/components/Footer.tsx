        ...
        <div className="container py-12 sm:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div className="flex flex-col gap-2 lg:-mt-12">
              <img src={logoFireskins} alt="FireSkins" <img src={logoFireskins} alt="FireSkins" className="h-40 lg:h-60 w-auto max-w-[600px] object-contain self-start -ml-4 lg:-ml-16" loading="lazy" /> loading="lazy" />
