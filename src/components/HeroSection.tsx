...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-16 overflow-hidden bg-cinematic">
      ...
      <div className="watermark top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap">FIRESKINS</div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center">
            ...
            <div className="relative animate-float">
              <img src={heroKnife} alt="Skin premium CS2" width={1280} height={720} className="w-full max-w-lg rounded-2xl glow-orange border border-primary/20" />
            </div>
          </div>
        </div>
      </div>
