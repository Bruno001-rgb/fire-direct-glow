...
const categories = [
  { title: "FACAS", description: "Karambit, Butterfly, Talon, Skeleton e muito mais.", image: knivesImg, query: "facas", button: "Quero ver facas no WhatsApp" },
  { title: "LUVAS", description: "Sport Gloves, Specialist Gloves, Driver Gloves e modelos raros.", image: glovesImg, query: "luvas", button: "Quero ver luvas no WhatsApp" },
];
    ...
    <section id="catalogo" className="py-24 relative overflow-hidden bg-cinematic">
      ...
      <div className="container relative z-10">
        ...
        <div className="grid sm:grid-cols-2 gap-8 max-w-3xl mx-auto">
          {categories.map((cat) => (
            <a key={cat.title} href={`${WHATSAPP_URL}${cat.query}`} target="_blank" rel="noopener noreferrer" className="group glass-card-glow overflow-hidden">
              <div className="aspect-square overflow-hidden relative">
                <img src={cat.image} alt={cat.title} loading="lazy" width={640} height={640} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
